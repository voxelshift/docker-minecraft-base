...
async function fetchPaperVersions(project) {
    return fetchTyped(`https://api.papermc.io/v2/projects/${project}`, paperVersionsResponseSchema);
}
...
async function getPaperBuilds(project, builds) {
